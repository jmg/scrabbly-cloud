...
urlpatterns = [
    ...
    path("play/", views.matchmaking, name="matchmaking"),
    path("play/<int:game_id>/poll/", views.match_poll, name="match_poll"),
    path("play/<int:game_id>/bot/", views.match_bot, name="match_bot"),
    path("play/<int:game_id>/cancel/", views.match_cancel, name="match_cancel"),
    path("game/ai/", views.create_ai_game, name="create_ai_game"),
    path("arenas/", views.arenas, name="arenas"),
    path("arenas/new/", views.arena_create, name="arena_create"),
    path("arenas/<int:arena_id>/", views.arena_detail, name="arena_detail"),
    path("arenas/<int:arena_id>/join/", views.arena_join, name="arena_join"),
    path("arenas/<int:arena_id>/leave/", views.arena_leave, name="arena_leave"),
    path("arenas/<int:arena_id>/play/", views.arena_play, name="arena_play"),
